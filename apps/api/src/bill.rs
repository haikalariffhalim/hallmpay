use crate::client::HallmPayClient;
...
impl<'a> CreateBillBuilder<'a> {
    ...
    pub async fn send(self) -> Result<BillResponse, HallmPayClientError> {
...
impl HallmPayClientClient {
    pub async fn get_bill(
        &self,
        bill_id: impl Into<String>,
    ) -> Result<BillResponse, HallmPayClientError> {
